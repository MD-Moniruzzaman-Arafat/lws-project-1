        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            ...
            <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div
                    ...
                    <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Relevant for multiple users,
                        extended
                        & premium support.</p>
                    <div className="flex items-baseline justify-center my-8">
                ...
                <div
                    ...
                    <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best for large scale uses and
                        extended
